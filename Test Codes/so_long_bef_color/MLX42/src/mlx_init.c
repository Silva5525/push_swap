...
/*   Updated: 2024/02/01 16:37:45 by wdegraf          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//= Private =//
// // Die framebuffer_callback-Funktion ist ein wesentlicher Bestandteil der 
// Fenstergrößen-Verwaltung in OpenGL-Anwendungen, die GLFW verwenden. Sie sorgt 
// dafür, dass das gerenderte Bild immer den gesamten verfügbaren Bereich des 
// Fensters ausfüllt und korrekt an Änderungen der Fenstergröße angepasst wird.
...
// Durch die Ausführung dieser Schritte bereitet mlx_create_buffers die 
// Rendering-Pipeline vor, indem es die notwendigen Ressourcen und Einstellungen 
// konfiguriert, die für das Zeichnen von Texturierten Geometrien mit OpenGL 
// erforderlich sind. Diese Initialisierung ist ein kritischer Schritt in der 
// Vorbereitung der Grafik-Engine, um effizient 
// Zeichnen und Texturieren von Objekten in der 3D-Welt zu ermöglichen.
 ...
 */
// Die Funktion mlx_compile_shader ist ein wesentlicher Baustein für 
// OpenGL-basierte Anwendungen, da sie eine flexible Kompilierung von Shadern 
// direkt aus dem Quelltext ermöglicht. Dies ist besonders nützlich in 
// Entwicklungsumgebungen, wo Shader oft modifiziert und neu kompiliert werden müssen.
